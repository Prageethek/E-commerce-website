...
export const PlaceOrder = () => {
  const [method, setMethod] = useState("cod"); //default Cash on delivery is selected
  const {navigate,backendUrl,cartItems,token,setCartItems,getCartItems,delivery_fee,products,getCartAmount} = useContext(ShopContext);
